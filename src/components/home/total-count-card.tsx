...
const DashboardeTotalCountCard = ({ resource, isLoading, totalCount }: Props) => {
    ...
    const config: AreaConfig = {
        ...
        areaStyle: () => {
            return {
                fill: `l(270) 0:#ffffff 0.2:${secondaryColor} 1:${primaryColor}`,
            }
        }
...
export default DashboardeTotalCountCard